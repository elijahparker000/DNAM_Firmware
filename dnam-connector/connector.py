...
INTERVAL_MINUTES = 1  # Kann angepasst werden
...
def save_sensor_data(sensor_id, data):
    ...
    status_code = data.get("status_code", 0)  # Statuscode basierend auf der Logik setzen
...
def main():
    ...
    for sensor_id in sensors_to_update:
        ...
        if sensor_data:
            ...
            send_sensor_data_to_api(sensor_id, sensor_data)  # Hier könnten Daten aktualisiert werden
